        ...
        <nav class="navbar navbar-default navbar-fixed-top navbar-sticky-function">
            ...
            <div class="container">
                ...
                <div class="logo-wrapper ">
                    <div class="logo ">
                        <a href="index.html"><img src="images/logo.png" alt="Logo" style="margin-left: 50%"/></a>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="category-group">
                                ...
                                <div class="icon">
                                    <i class="flaticon-streamline-outline-home"></i>
                                </div>
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="category-group">
                                ...
                                <h4>Add Recipe</h4>
                                <p class="mt-15">Add Recipe With Ingredients & other perimeter.</p>
